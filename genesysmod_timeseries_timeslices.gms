...
parameter CountryData_Hydro_RoR(HOUR,TIMESLICE,REGION_FULL);
...
se=0
         ...
         par=CountryData_HeatPump_GroundSource           Rng=HP_GROUNDSOURCE!A1            rdim=2    cdim=1
         par=CountryData_HeatPump_AirSource              Rng=HP_AIRSOURCE!A1            rdim=2    cdim=1
         par=CountryData_Hydro_RoR                       Rng=HYDRO_ROR!A1            rdim=2    cdim=1
$offecho
$ifi %switch_only_load_gdx%==0 $call "gdxxrw %inputdir%%hourly_data_file%.xlsx @%tempdir%temp_%hourly_data_file%.tmp o=%gdxdir%%hourly_data_file%.gdx MaxDupeErrors=9999 CheckDate";
$GDXin %gdxdir%%hourly_data_file%.gdx
$onUNDF
$load CountryData_PV_inf, CountryData_PV_avg, CountryData_PV_opt, CountryData_Wind_Onshore_inf, CountryData_Wind_Onshore_avg, CountryData_Wind_Onshore_opt, CountryData_HeatPump_GroundSource, CountryData_HeatPump_AirSource, CountryData_Load, CountryData_Wind_Offshore, CountryData_Heat_High, CountryData_Heat_Low, CountryData_Mobility_Psng, EntriesPerTimeslice, CountryData_Hydro_RoR
$offUNDF
...
CountryData(r, h, l, 'hydro_ror') = CountryData_Hydro_RoR(h, l, r);
...
CapacityFactor(r,'Res_Wind_Offshore_Deep',l,y) = CountryDataPerTimeslice(r,l,'wind_offshore')*1.15;
...
CapacityFactor(r,'Res_Wind_Offshore_Shallow',l,y) = CountryDataPerTimeslice(r,l,'wind_offshore')*0.825;
...
CapacityFactor(r,'RES_Hydro_Small',l,y) = CountryDataPerTimeslice(r,l,'hydro_ror');
