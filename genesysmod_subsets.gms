...
Transformation('D_Battery_Li-Ion') = yes;
Transformation('D_Battery_Redox') = yes;
Transformation('D_Gas_Methane') = yes;
Transformation('D_Gas_H2') = yes;
Transformation('D_CAES') = yes;
Transformation('D_Heat_HLI') = yes;
Transformation('D_Heat_HLR') = yes;
Transformation('D_PHS') = yes;
