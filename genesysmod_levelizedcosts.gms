...
$include genesysmod_emissionintensity.gms
...
$ifthen %switch_only_write_results% == 1
$else
*VariableCost(r,t,m,y) = VariableCost(r,t,m,y) / 5;
*FixedCost(r,t,y) = FixedCost(r,t,y)/5;
$endif
...
capitalcosts(r,t,f,m,y)$(OutputActivityRatio(r,t,f,m,y) > 0 and maxgeneration(r,t,y,m,f) > 0)  = (CapitalCost(r,t,y)) /
sum(o$(o.val <= OperationalLife(r,t)),(maxgeneration(r,t,y,m,f)/((1+GeneralDiscountRate(r))**o.val)));
omcosts(r,t,f,m,y)$(OutputActivityRatio(r,t,f,m,y) > 0 and maxgeneration(r,t,y,m,f) > 0) = (sum(o$(o.val <= OperationalLife(r,t)),((FixedCost(r,t,y)+(VariableCost(r,t,m,y))*maxgeneration(r,t,y,m,f))/((1+GeneralDiscountRate(r))**o.val)))) /
sum(o$(o.val <= OperationalLife(r,t)),(maxgeneration(r,t,y,m,f)/((1+GeneralDiscountRate(r))**o.val)));
...
discountedfuelcosts(r,t,'Power',m,y)$(OutputActivityRatio(r,t,'Power',m,y) > 0 and maxgeneration(r,t,y,m,'Power') > 0) = (sum(o$(o.val <= OperationalLife(r,t)),(((fuelcosts(r,t,'Power',m,y))*maxgeneration(r,t,y,m,'Power'))/((1+GeneralDiscountRate(r))**o.val)))) /
sum(o$(o.val <= OperationalLife(r,t)),(maxgeneration(r,t,y,m,'Power')/((1+GeneralDiscountRate(r))**o.val)));

testlevelizedcostsPJ(r,t,'Power',m,y)$(OutputActivityRatio(r,t,'Power',m,y) > 0 and maxgeneration(r,t,y,m,'Power') > 0) = (CapitalCost(r,t,y)+sum(o$(o.val <= OperationalLife(r,t)),((FixedCost(r,t,y)+(VariableCost(r,t,m,y)+fuelcosts(r,t,'Power',m,y))*maxgeneration(r,t,y,m,'Power'))/((1+GeneralDiscountRate(r))**o.val)))) /
sum(o$(o.val <= OperationalLife(r,t)),(maxgeneration(r,t,y,m,'Power')/((1+GeneralDiscountRate(r))**o.val)));
...
discountedfuelcosts(r,t,'H2',m,y)$(OutputActivityRatio(r,t,'H2',m,y) > 0 and maxgeneration(r,t,y,m,'H2') > 0) = (sum(o$(o.val <= OperationalLife(r,t)),(((fuelcosts(r,t,'H2',m,y))*maxgeneration(r,t,y,m,'H2'))/((1+GeneralDiscountRate(r))**o.val)))) /
sum(o$(o.val <= OperationalLife(r,t)),(maxgeneration(r,t,y,m,'H2')/((1+GeneralDiscountRate(r))**o.val)));
...
discountedfuelcosts(r,t,TierThree,m,y)$(OutputActivityRatio(r,t,TierThree,m,y) > 0 and maxgeneration(r,t,y,m,TierThree) > 0) = (sum(o$(o.val <= OperationalLife(r,t)),(((fuelcosts(r,t,TierThree,m,y))*maxgeneration(r,t,y,m,TierThree))/((1+GeneralDiscountRate(r))**o.val)))) /
sum(o$(o.val <= OperationalLife(r,t)),(maxgeneration(r,t,y,m,TierThree)/((1+GeneralDiscountRate(r))**o.val)));
...
fuelcosts(r,t,f,m,y)$(OutputActivityRatio(r,t,f,m,y) > 0) = sum(fff,InputActivityRatio(r,t,fff,m,y)*resourcecosts(r,fff,y))/OutputActivityRatio(r,t,f,m,y);
fuelcosts(r,StorageDummies,f,'1',y)$(OutputActivityRatio(r,StorageDummies,f,'2',y) > 0) = sum(fff,InputActivityRatio(r,StorageDummies,fff,'1',y)*resourcecosts(r,fff,y))/(OutputActivityRatio(r,StorageDummies,f,'2',y)*sum(s,TechnologyToStorage(y,'1',StorageDummies,s)**2));
...
*resourcecosts(r,f,y)$(resourcecosts(r,f,y) = 0 and AnnualProduction(y,f,r) = 0) = sum((t,m),(levelizedcostsPJ(r,t,f,m,y)))/sum((t,m)$(OutputActivityRatio(r,t,f,m,y) <> 0),1);
...
fuelcosts(r,t,f,m,y)$(OutputActivityRatio(r,t,f,m,y) > 0) = sum(fff,InputActivityRatio(r,t,fff,m,y)*resourcecosts(r,fff,y))/OutputActivityRatio(r,t,f,m,y);
discountedfuelcosts(r,t,TierFive,m,y)$(OutputActivityRatio(r,t,TierFive,m,y) > 0 and maxgeneration(r,t,y,m,TierFive) > 0) = (sum(o$(o.val <= OperationalLife(r,t)),(((fuelcosts(r,t,TierFive,m,y))*maxgeneration(r,t,y,m,TierFive))/((1+GeneralDiscountRate(r))**o.val)))) /
sum(o$(o.val <= OperationalLife(r,t)),(maxgeneration(r,t,y,m,TierFive)/((1+GeneralDiscountRate(r))**o.val)));
...
output_costs('Capex',r,t,Transport,m,y) = capitalcosts(r,t,Transport,m,y)/3.6;
output_costs('OandM',r,t,Transport,m,y) = omcosts(r,t,Transport,m,y)/3.6;
output_costs('Fuelcosts',r,t,Transport,m,y) = discountedfuelcosts(r,t,Transport,m,y)/3.6;
output_costs('Emissions',r,t,Transport,m,y) = emissioncosts(r,t,Transport,m,y)/3.6;
output_costs('TotalLevelized',r,t,Transport,m,y) = levelizedcostskWh(r,t,Transport,m,y)/3.6;
