...
DepreciationMethod('%model_region%') = DepreciationMethod('%data_base_region%');
GeneralDiscountRate('%model_region%') = GeneralDiscountRate('%data_base_region%');
TechnologyDiscountRate('%model_region%',t) = TechnologyDiscountRate('%data_base_region%',t);
SocialDiscountRate('%model_region%') = SocialDiscountRate('%data_base_region%');
