...
y_endogenousfuelcosts('Biomass',y,r) = sum(Biomass,VariableCost(r,Biomass,'1',y)/5)/card(Biomass) ;
...
y_endogenousfuelcostspertimeslice('Biomass',y,l,r) = sum(Biomass,VariableCost(r,Biomass,'1',y)/5)/card(Biomass) ;
...
y_fuelcosts('Biomass',y,r,amnt) = sum(Biomass,VariableCost(r,Biomass,'1',y)/5)/card(Biomass) ; ;
...
z_FuelProducedByCarrier(y,r,'Biomass',f) = sum((Biomass),ProductionByTechnologyAnnual.l(y,Biomass,f,r));
...
excel_sectors(r,'PowerProd',dm,'PJ','%emissionPathway%_%emissionScenario%',y) =  z_FuelProducedByCarrier(y,r,dm,'Power');
excel_sectors(r,'PowerUse','Residential','PJ','%emissionPathway%_%emissionScenario%',y) = SpecifiedAnnualDemand(r,'Power',y)* z_residentialdemandshare(r);
excel_sectors(r,'PowerUse','Industrial','PJ','%emissionPathway%_%emissionScenario%',y) = SpecifiedAnnualDemand(r,'Power',y)* (1- z_residentialdemandshare(r));
excel_sectors(r,'PowerUse','Sector-Coupling','PJ','%emissionPathway%_%emissionScenario%',y) = ProductionAnnual.l(y,'Power',r)-SpecifiedAnnualDemand(r,'Power',y)-sum(StorageDummies,ProductionByTechnologyAnnual.l(y,StorageDummies,'Power',r));


excel_sectors(r,'HeatLowBuildings',f,'PJ','%emissionPathway%_%emissionScenario%',y) = sum(HeatLowRes,UseByTechnologyAnnual.l(y,HeatLowRes,f,r));
excel_sectors(r,'HeatLowIndustry',f,'PJ','%emissionPathway%_%emissionScenario%',y) = sum(HeatLowInd,UseByTechnologyAnnual.l(y,HeatLowInd,f,r));
excel_sectors(r,'HeatMediumIndustry',f,'PJ','%emissionPathway%_%emissionScenario%',y) = sum(HeatMedInd,UseByTechnologyAnnual.l(y,HeatMedInd,f,r));
excel_sectors(r,'HeatHighIndustry',f,'PJ','%emissionPathway%_%emissionScenario%',y) = sum(HeatHighInd,UseByTechnologyAnnual.l(y,HeatHighInd,f,r));

excel_sectors(r,'PassengerTransport',f,'PJ','%emissionPathway%_%emissionScenario%',y) = sum(Passenger,UseByTechnologyAnnual.l(y,Passenger,f,r));
excel_sectors(r,'FreightTransport',f,'PJ','%emissionPathway%_%emissionScenario%',y) = sum(Freight,UseByTechnologyAnnual.l(y,Freight,f,r));

excel_lvlcosts(r,t,f,m,l,'LevelizedTechnologyCostsPerTimeslice','Endogenous',y) =  y_endogenouslevelizedtechnologycostspertimeslice(f,m,y,l,t,r);
excel_lvlcosts(r,t,f,m,'N/A','LevelizedTechnologyCosts','Endogenous',y) = y_endogenouslevelizedtechnologycosts(f,m,y,t,r);
excel_lvlcosts(r,t,f,m,'N/A','LevelizedTechnologyCosts',amnt,y) = y_levelizedtechnologycosts(f,m,y,t,r,amnt);


excel_lvlcosts(r,'N/A',f,'N/A',l,'FuelCostsPerTimeSlice','Endogenous',y) = y_endogenousfuelcostspertimeslice(f,y,l,r);
excel_lvlcosts(r,'N/A',f,'N/A','N/A','FuelCosts','Endogenous',y) =  y_endogenousfuelcosts(f,y,r);
excel_lvlcosts(r,'N/A',f,'N/A','N/A','FuelCosts',amnt,y) =  y_fuelcosts(f,y,r,amnt);
